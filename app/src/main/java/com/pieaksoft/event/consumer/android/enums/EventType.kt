...
enum class EventCode(val code: String) : Parcelable {
    ...
    IMMEDIATE_LOG_WITH_CONVENTIONAL_LOCATION_PRECISION("IMMEDIATE_LOG_WITH_CONVENTIONAL_LOCATION_PRECISION"),
    IMMEDIATE_LOG_WITH_REDUCED_LOCATION_PRECISION("IMMEDIATE_LOG_WITH_REDUCED_LOCATION_PRECISION"),
